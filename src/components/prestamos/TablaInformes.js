...
export default class TablaInformes extends Component {
  render() {
    const {
      atejerina,
      mgalian,
    ...
    return (
      <div>
        <div className="mt-4 mb-4">
          <h2 className="mt-4">Prestamos Aprobados Realizados por Operador</h2>
        ...
        <div className="mt-4 mb-4">
          <h2 className="mt-4">Prestamos Segun Estado</h2>
          <div className="d-flex justify-content-between text-center border-bottom  border-dark  ">
            <div className="col-2">
              {" "}
