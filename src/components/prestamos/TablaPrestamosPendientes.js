...
import { aprobarPrestamos } from "../../actions/prestamosActions";

import { connect } from "react-redux";
import { Link } from "react-router-dom";

class TablaPrestamosPendientes extends React.Component {
  constructor() {
    super();
    this.state = {
      caso: {},
  ...
  aprobarPrestamos = row => {
    const id = row.original.ptm_id;

    this.props.aprobarPrestamos(id);
                  ...
                  Cell: row => (
                    <div>
                      <Link
                        ...
                        onClick={() => this.aprobarPrestamos(row)}
                      >
                        Aprobar
                      </Link>
                    </div>
...
export default connect(mapStateToProps, { aprobarPrestamos })(
