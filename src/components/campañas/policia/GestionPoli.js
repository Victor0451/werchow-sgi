...
import {
  campanaOperadorPoli,
  campanaOperadorNotiPoli,
  gestionCaso,
  updateAccion,
  campanaOperadorTrabPoli,
  cerrarCaso,
  getGestionCaso,
  getRecuperacion,
  getDeuda
...
class GestionPoli extends Component {
  ...
  componentDidMount() {
    ...
    this.props.campanaOperadorPoli(id);
    this.props.campanaOperadorTrabPoli(id);
    this.props.campanaOperadorNotiPoli(id);
  ...
  render() {
    ...
    return (
      <div className="container">
        <h1 className="mt-4 mb-4"> Gestion Campaña de Policias {mes}</h1>
